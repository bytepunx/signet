...
func (x *GetServiceConfigResponse) GetContent() *structpb.Value {
	if x != nil {
		return x.Content
	}
	return nil
...
const file_admin_v1_admin_proto_rawDesc = "" +
	...
	"\aversion\x18\x01 \x01(\x05R\aversion\"Q\n" +
	...
	"\x10GetServiceConfig\x12!.admin.v1.GetServiceConfigRequest\x1a\".admin.v1.GetServiceConfigResponseB1Z/github.com/bytepunx/signet/gen/admin/v1;adminv1b\x06proto3"
